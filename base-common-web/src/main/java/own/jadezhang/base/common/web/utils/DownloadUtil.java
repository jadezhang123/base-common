package own.jadezhang.base.common.web.utils;

import org.apache.commons.io.IOUtils;
import own.jadezhang.base.common.config.Configurations;
import own.jadezhang.base.common.exception.BizException;
import own.jadezhang.base.common.exception.DownloadException;
...
public class DownloadUtil {
    ...
    private static String compressFiles(File[] files, FilenameGenerator fileNameGenerator) throws DownloadException {
        String tempDir = configurations !=null ? configurations.getTempPath() : System.getProperty("java.io.tmpdir");
        String compressedFilePath = tempDir + File.separator + System.currentTimeMillis() + "-temp.zip";
